...
rb = Init_Model(model, robot_name='Cobra600', twist_in_rads=True, plt_model=True)

center = [0.2,       0.1,       0.2,       3.14159265, 0.,         1.57079633]  # Center of the circle
circle = rb.traj.create_circle_traj(radius=0.07, cent=center)
jt = rb.traj.wayp_to_joint_angle(circle, xyz_mask=[1, 1, 1, 0, 0, 1])
